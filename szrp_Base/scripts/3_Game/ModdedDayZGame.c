modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "SurvivorZ_RP/szrp_Base/data/SurvivorZ.edds");
		m_ImageBackground.LoadMaskTexture("SurvivorZ_RP/szrp_Base/data/SurvivorZ.edds");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadMaskTexture("SurvivorZ_RP/szrp_Base/data/SurvivorZ.edds");
		imageWidgetBackground.LoadImageFile(0, "SurvivorZ_RP/szrp_Base/data/SurvivorZ.edds");
		return w;
	}
}
